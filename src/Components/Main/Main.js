      ...
      <div className="main">
        ...
        >
          <KeyBinding
            onKey={(e) => {
              switch (true) {
                case e.altKey === true && e.ctrlKey === true && e.key === "u":
                  this.undoStep();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "r":
                  this.redoStep();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "s":
                  this.makeThisLive();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "o":
                  this.makeThisOffline();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "t":
                  this.toggleEraserSlider();
                  this.eraserClick();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "p":
                  this.toggleColorPicker();
                  this.setColor();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "c":
                  this.clearBoard();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "q":
                  this.zoomIn();
                  break;
                case e.altKey === true && e.ctrlKey === true && e.key === "w":
                  this.zoomOut();
                  break;
              }
            }}
